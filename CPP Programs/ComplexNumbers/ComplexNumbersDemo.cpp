...
int main(){
	...
	//Tests added by Tanner Gordon
	cout << "Beginning stream demo..." << endl;
	cout << "Please enter two complex numbers: ";
	ComplexNumber m1, m2;
	cin >> m1 >> m2;
	...
	ComplexNumber m3 = m1 - m2;
	cout << "M1 - M2 = " << m3 << endl << endl;
	
	cout << "Multiplication demo: " << endl;

	ComplexNumber m4 = m1 * m2;
	cout << "M1 * M2 = " << m4 << endl << endl;
	

	ComplexNumber m1Conj = m1.conjugate();
	ComplexNumber m2Conj = m2.conjugate();
	double m1Mag = m1.magnitude();
	double m2Mag = m2.magnitude();

	cout << "The conjugate of m1 is " << m1Conj << endl;
	cout << "The conjugate of m2 is " << m2Conj << endl;
	cout << "The magnitude of m1 is " << m1Mag << endl;
	cout << "The magnitude of m2 is " << m2Mag << endl;
